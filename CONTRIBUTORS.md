...
- DreamView packet and state behavior adapted from Tom Lasswell and Florian Lagg's MIT-licensed [lasswellt/govee-homeassistant](https://github.com/lasswellt/govee-homeassistant), particularly [`e7fbb97`](https://github.com/lasswellt/govee-homeassistant/commit/e7fbb97) and [`623235e`](https://github.com/lasswellt/govee-homeassistant/commit/623235e); transport order was deliberately changed to LAN-first for this fork.
