...
- Report cloud reachability independently from the newest LAN/IoT device state instead of showing
  `Cloud: unknown`, distinguish unpollable cloud-only controls, and treat a
  sent-but-unanswered IoT poll as unavailable.
